...
from .genome_browser          import genome_browser_bp
from .variant_annotation      import variant_annotation_bp
...
from .phenotype_comparison    import phenotype_comparison_bp
