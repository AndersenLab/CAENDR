...
from caendr.services.cloud.storage    import upload_blob_from_file_object, check_blob_exists
...
def add_trait(form_data, user):
  """ 
    ...
    On the failure of any of the above operations rolls back to the initial state and return an error message.
  """
  try:
