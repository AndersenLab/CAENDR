...
# API
from base.views.api import api_database_bp, api_gene_bp, api_notifications_bp, api_trait_bp
...
def register_blueprints(app):
  ...
  # API
  app.register_blueprint(api_database_bp,      url_prefix='/api/database')
